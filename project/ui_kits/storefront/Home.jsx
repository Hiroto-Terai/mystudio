...
const { Button, ProductCard, Tag } = window.HirotDesignSystem_e62cf3;

function HeroSection({ onShop, reverse }) {
  const copy = (
    <div key="copy">
...
function FeaturedGrid({ products, onOpen, onAdd, cols = 4 }) {
  return (
...
function HirotHome({ data, onOpenProduct, onAdd, onShop, cols = 4, heroReverse = false }) {
  return (
    <div>
