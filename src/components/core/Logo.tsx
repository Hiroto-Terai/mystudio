...
export interface LogoProps extends Omit<HTMLAttributes<HTMLSpanElement>, "style"> {
...
export function Logo({
  ...
  if (variant === "mark") {
    return (
      <span style={{ display: "inline-flex", ...style }} aria-label="Hirot" role="img" {...rest}>
        {mark}
      </span>
    );
  }
